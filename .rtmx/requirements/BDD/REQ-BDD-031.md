# REQ-BDD-031: Rubber Sheet georeferencing Gherkin

## Description
ATAK Civilian Software User Manual chapter specified as Gherkin so behavior can
be checked the same way on every platform. File: `specs/rubber-sheet.feature`.

Scenarios: Import 2D edit 3D ENU export KMZ.

## Acceptance Criteria
- [x] `specs/rubber-sheet.feature` exists
