# REQ-BDD-027: Lasso Select export and delete Gherkin

## Description
ATAK Civilian Software User Manual chapter specified as Gherkin so behavior can
be checked the same way on every platform. File: `specs/lasso.feature`.

Scenarios: Circle items export delete empty.

## Acceptance Criteria
- [x] `specs/lasso.feature` exists
