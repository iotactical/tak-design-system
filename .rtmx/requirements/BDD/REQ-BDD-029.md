# REQ-BDD-029: Contour Lines generation Gherkin

## Description
ATAK Civilian Software User Manual chapter specified as Gherkin so behavior can
be checked the same way on every platform. File: `specs/contour-lines.feature`.

Scenarios: Generate toggle major-minor interval restart.

## Acceptance Criteria
- [x] `specs/contour-lines.feature` exists
