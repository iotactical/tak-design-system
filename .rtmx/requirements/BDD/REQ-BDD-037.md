# REQ-BDD-037: Laser Range Finder and Bluetooth Gherkin

## Description
ATAK core tool specified as Gherkin from SUM prose and Settings XML so behavior
can be checked the same way on every platform. File: `specs/sensors.feature`.

Scenarios: Enable BT rescan LRF hide PLRF.

## Acceptance Criteria
- [x] `specs/sensors.feature` exists
