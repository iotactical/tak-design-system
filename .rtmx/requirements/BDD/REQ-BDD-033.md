# REQ-BDD-033: Toolbar Manager layouts Gherkin

## Description
ATAK Civilian Software User Manual chapter specified as Gherkin so behavior can
be checked the same way on every platform. File: `specs/toolbar-manager.feature`.

Scenarios: Default five tools edit export legacy bar.

## Acceptance Criteria
- [x] `specs/toolbar-manager.feature` exists
