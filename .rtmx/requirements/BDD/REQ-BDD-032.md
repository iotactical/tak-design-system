# REQ-BDD-032: TAK Package Management and other features Gherkin

## Description
ATAK Civilian Software User Manual chapter specified as Gherkin so behavior can
be checked the same way on every platform. File: `specs/plugins.feature`.

Scenarios: View mgmt load Update Server Link EUD feedback.

## Acceptance Criteria
- [x] `specs/plugins.feature` exists
